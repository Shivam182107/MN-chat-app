...
const UserSignup = () => {
  ...
  return (
    <>
      <motion.div className="min-h-screen w-full flex items-center"
        initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }}>
        <div className="max-w-7xl mx-auto w-full flex md:flex-row flex-col">

          {/* LEFT IMAGE */}
          <motion.div className="flex-1 flex justify-center items-center p-6"
            initial={{ x: -30, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.7 }}>
          ...
          {/* RIGHT FORM */}
          <motion.div className="flex-1 flex flex-col justify-center px-6 sm:px-10 md:px-12 py-6"
            initial={{ x: 30, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.7 }}>
